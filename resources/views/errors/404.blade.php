...
<head>
    ...
    <title>Page Not Found - BsnCard</title>
...
<body class="min-h-screen bg-gray-50 font-sans antialiased flex items-center justify-center px-4">
    <div class="text-center max-w-md">
        ...
        <p class="text-8xl font-black text-gray-200 mb-2">404</p>
        <h1 class="text-xl font-bold text-gray-900 mb-2">Page not found</h1>
        <p class="text-sm text-gray-500 mb-8 leading-relaxed">The page you're looking for doesn't exist or has been moved.</p>
        <div class="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a href="javascript:history.back()" class="inline-flex items-center justify-center px-6 py-2.5 bg-white text-gray-700 text-sm font-semibold rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors">
                Go back
            </a>
        </div>
    </div>
