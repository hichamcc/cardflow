...
<head>
    ...
    <title>Access Denied - BsnCard</title>
...
<body class="min-h-screen bg-gray-50 font-sans antialiased flex items-center justify-center px-4">
    <div class="text-center max-w-md">
        ...
        <p class="text-8xl font-black text-gray-200 mb-2">403</p>
        <h1 class="text-xl font-bold text-gray-900 mb-2">Access denied</h1>
        <p class="text-sm text-gray-500 mb-8 leading-relaxed">You don't have permission to access this page.</p>
