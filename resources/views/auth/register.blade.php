...
<div class="space-y-6">
    <x-auth-header :title="__('Create your account')" :description="__('Start building your digital business cards today')" />
    ...
    <a href="{{ route('auth.google') }}" class="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700">
    ...
    <p class="text-center text-sm text-gray-500 dark:text-gray-400">
        ...
        <x-link :href="route('login')" class="font-semibold">{{ __('Log in') }}</x-link>
    </p>
</div>
</x-layouts.auth>
