<x-layouts.app :title="__('New Project')">
    <div class="flex h-full w-full flex-1 flex-col gap-6">
        ...
        <div>
            <x-heading size="xl" level="1">{{ __('New Project') }}</x-heading>
        </div>

        <x-form method="post" action="{{ route('projects.store') }}">
            <div class="mx-auto max-w-2xl space-y-6">
                <div class="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-900">
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name') }}" required placeholder="{{ __('Project name') }}"
                ...
                <div class="flex items-center justify-end gap-3">
                    <a href="{{ route('projects.index') }}" class="rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700">
                        {{ __('Cancel') }}
                    </a>
